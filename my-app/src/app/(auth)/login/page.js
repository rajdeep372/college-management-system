...
const LoginPage = () => {
    ...
    useEffect(() => {
        // Trigger the entry animation after the component mounts
    ...
    const pageStyle = {
        ...
        padding: '20px',
        background: 'linear-gradient(-45deg, #161625, #1a1a2e, #2a2a4e, #00c6ff)',
        backgroundSize: '400% 400%',
        animation: 'gradient-animation 15s ease infinite',
        marginLeft: '-250px', // Offset the sidebar width to truly center the content
    };
            ...
            <div style={pageStyle}>
                <div style={formContainerStyle}>
                    <form onSubmit={handleSubmit} style={formStyle}>
                        <h2 style={{ textAlign: 'center', color: '#e0e0e0', marginBottom: '30px' }}>Teacher Login</h2>
                        ...
                        <button type="submit" style={buttonStyle} onMouseEnter={() => setIsButtonHovered(true)} onMouseLeave={() => setIsButtonHovered(false)}>Login</button>
                        <Link href="/signup" style={linkStyle}>Don't have an account? Sign Up</Link>
                    </form>
                </div>
            </div>
        </>
